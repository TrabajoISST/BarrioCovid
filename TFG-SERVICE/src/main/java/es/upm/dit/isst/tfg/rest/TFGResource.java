...
public class TFGResource {
	...
	public List<TFG> readAll() {
		...
		return TFGDAOImplementation.getInstance().readAll();//Usa el CRUD: readAll()
	...
	public Response create(TFG tnew) throws URISyntaxException {
		...
		TFG t = TFGDAOImplementation.getInstance().create(tnew);
	...
	public Response read(@PathParam("id") String id) {
		...
		TFG t = TFGDAOImplementation.getInstance().read(id);
	...
	public Response delete(@PathParam("id") String id) {
		...
		TFG rold = TFGDAOImplementation.getInstance().read(id);

		if (rold == null)
			return Response.notModified().build();

		System.out.print("\n");
		TFGDAOImplementation.getInstance().delete(rold);
