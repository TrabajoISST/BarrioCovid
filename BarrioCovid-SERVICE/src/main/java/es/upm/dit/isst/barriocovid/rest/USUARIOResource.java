...
public class USUARIOResource {
		...
		//Traer todos los vendedores de una zona X
		@GET
		@Path("zona/{id}")
		@Produces(MediaType.APPLICATION_JSON)
		public List<USUARIO> vendedoresEnZona (@PathParam("id") String zona) {
			return USUARIODAOImplementation.getInstance().vendedoresZona(zona);
		}

		
		//Traer todos los voluntarios con total de pedidos X
		@GET
		@Path("numeroPedidos/{id}")
		@Produces(MediaType.APPLICATION_JSON)
		public List<USUARIO> voluntariosEnEntrega (@PathParam("id") int count) {
			return USUARIODAOImplementation.getInstance().pedidosRealizados(count);
		}
