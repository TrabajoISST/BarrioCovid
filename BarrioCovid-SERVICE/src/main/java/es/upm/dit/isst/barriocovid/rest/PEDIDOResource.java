...
public class PEDIDOResource {
		...
		//Traer pedidos con status igual a X
		
		@GET
		@Path("statusPedido/{id}")
		@Produces(MediaType.APPLICATION_JSON)
		public List<PEDIDO> statusPedidos (@PathParam("id") int status) {
			return PEDIDODAOImplementation.getInstance().statusPedidos(status);
		}
