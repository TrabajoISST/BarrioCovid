...
public class USUARIODAOImplementation implements USUARIODAO{
	...
	public List<USUARIO> vendedoresZona(String zona) {
		...
		for (USUARIO registro : this.readAllUSUARIO())
			if (registro.getZona().equals(zona)) {

				res.add(registro);
			}

		System.out.println("\n");
		System.out.print("Lista de vendedores en la zona  " + zona + " es : " + res.size());
		System.out.println("\n");
	...
	public List<USUARIO> pedidosRealizados (int count) {
		List<USUARIO> res = new ArrayList<USUARIO>();
		for (USUARIO registro : this.readAllUSUARIO())
			if (registro.getPedidosRealizados() == count) {
				System.out.println(registro);
				res.add(registro);
			}
		
		System.out.println("\n");
		System.out.print("Total de voluntarios que han hecho "+ count + " pedidos es: "  + res.size() );
		System.out.println("\n");
